...
[← Back to Architecture Index](./README.md) | [← Previous: Project Structure](./04-project-structure.md) | [Next: Data Architecture →](./06-data-architecture.md)
...
[← Previous: Project Structure](./04-project-structure.md) | [Next: Data Architecture →](./06-data-architecture.md) | [Back to Index](./README.md)
